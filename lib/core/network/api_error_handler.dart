...
extension DataSourceExtension on DataSource {
  ApisErrorModel getFailure() {
    switch (this) {
      case DataSource.NO_CONTENT:
        return ApisErrorModel(
...
class ErrorHandler implements Exception {
  late ApisErrorModel apiErrorModel;
...
ApisErrorModel _handleError(DioException error) {
  switch (error.type) {
    ...
    case DioExceptionType.badResponse:
      if (error.response != null &&
        ...
        return ApisErrorModel.fromJson(error.response!.data);
      } else {
