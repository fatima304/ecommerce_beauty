...
class _ApiMakeupServices implements ApiMakeupServices {
  _ApiMakeupServices(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
...
class _ApiAuthServices implements ApiAuthServices {
  ...
  @override
  Future<RegisterModelResponse> sighUp(FormData formData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<LoginModelResponse> signIn(LoginBodyRequest loginBodyRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
